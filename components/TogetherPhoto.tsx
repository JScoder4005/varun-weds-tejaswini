    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(212,80,106,0.1) 0%, transparent 70%)",
          pointerEvents: "none",
          zIndex: 0,
        }}
      />
        ...
        >
          ...
          <motion.div
            ...
            style={{
              ...
              borderRadius: 32,
              background:
                "conic-gradient(from 0deg, rgba(212,80,106,0.6), rgba(201,168,76,0.4), rgba(255,158,181,0.6), rgba(201,168,76,0.2), rgba(212,80,106,0.6))",
              zIndex: 0,
              filter: "blur(2px)",
            }}
          />
          ...
          >
            <motion.div
              style={{ y, width: "100%", height: "100%", position: "relative" }}
            >
              <Image
              ...
              <div
                style={{
                  ...
                  bottom: 0,
                  background:
                    "radial-gradient(ellipse at center, transparent 50%, rgba(6,13,31,0.5) 100%)",
                }}
              />
              ...
              <div
                style={{
                  ...
                  background:
                    "linear-gradient(to top, rgba(6,13,31,0.95) 0%, transparent 100%)",
                }}
              >
                <motion.p
                  initial={{ opacity: 0, y: 20 }}
